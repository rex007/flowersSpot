...
ActiveRecord::Schema.define(version: 20180319182311) do
  ...
  create_table "likes", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "sightings_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["sightings_id"], name: "index_likes_on_sightings_id"
  ...
  add_foreign_key "likes", "sightings", column: "sightings_id"
